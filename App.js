        ...
        options = {
            {
                tabBarIcon: ({ focused }) => {
                    return ( <
                        ...
                        /> <
                        Text style = {
                            { fontSize: 12, color: 'black' } } > Home < /Text> <
                        /View>
                    )
        ...
        options = {
            {
                tabBarIcon: ({ focused }) => {
                    return ( <
                        ...
                        /> <
                        Text style = {
                            { fontSize: 12, color: 'black' } } > Menu < /Text> <
                        /View>
                    )
        ...
        options = {
            {
                tabBarIcon: ({ focused }) => {
                    return ( <
                        ...
                        /> <
                        Text style = {
                            { fontSize: 12, color: 'black' } } > Cart < /Text> <
                        /View>
                    )
                }
            }
...
export default function App() {
    ...
    return ( <
        ...
        options = {
            { headerShown: true, } }
        /> <
        Stack.Screen name = "CardBurger"
        component = { CardBurger }
        options = {
            { headerShown: true, } }
        /> <
        Stack.Screen name = "CardBiryani"
        component = { CardBiryani }
        options = {
            { headerShown: true, } }
        /> <
        Stack.Screen name = "CardBeverages"
        component = { CardBeverages }
        options = {
            { headerShown: true, } }
        /> <
        Stack.Screen name = "CardChicken"
        component = { CardChicken }
        options = {
            { headerShown: true, } }
        /> <
        Stack.Screen name = "CardDesserts"
        component = { CardDesserts }
        options = {
            { headerShown: true, } }
        /> <
        Stack.Screen name = "CardPaneer"
        component = { CardPaneer }
        options = {
            { headerShown: true, } }
        /> <
        /Stack.Navigator> <
